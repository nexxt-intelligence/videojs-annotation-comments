                ...
                },
                {
                  ...
                  value: function teardown() {
                    ...
                    if (removeFromCollection)
                      _get(
                        Annotation.prototype.__proto__ ||
                          Object.getPrototypeOf(Annotation.prototype),
                        'teardown',
                        this
                      ).call(this);
                  }
...
*/
      ...
      */
        ...
        { './../lib/player_component': 41, './../lib/utils': 44, './annotation': 29 }
      ],
      31: [
        function (require, module, exports) {
          'use strict';
...
*/
        ...
        { './../lib/player_ui_component': 42, './../lib/utils': 44, moment: 25 }
      ],
      32: [
        function (require, module, exports) {
          'use strict';
...
*/
        ...
        { './../lib/player_ui_component': 42, './../lib/utils': 44, './comment': 31 }
      ],
      33: [
        function (require, module, exports) {
          'use strict';
                ...
                value: function bindEvents(bindArrowKeys) {
                  ...
                  if (this.internalCommenting) {
                    this.$player
                      ...
                      .on('click.vac-control', '.vac-emoji-container .vac-emoji-block', function (
                        e
                      ) {
                ...
                value: function bindCursorTooltip() {
                  ...
                  $(document).on(
                    ...
                    Utils.throttle(function (event) {
                      ...
                      var atRightEdge =
                        cursorX + _this3.tooltipArea.width + margin * 2 >= rightEdge;
                      var atBottomEdge =
...
*/
        ...
        { './../lib/player_ui_component': 42, './../lib/utils': 44 }
      ],
      36: [
        function (require, module, exports) {
          'use strict';
            ...
            _createClass(PlayerButton, [
              ...
              },
              {
                ...
                value: function teardown() {
                  ...
                  _get(
                    PlayerButton.prototype.__proto__ ||
                      Object.getPrototypeOf(PlayerButton.prototype),
                    'teardown',
                    this
                  ).call(this);
                }
